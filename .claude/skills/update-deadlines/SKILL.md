...
- **`submission_type`**: e.g., `"Full papers"`, `"Short papers"`, `"Research Papers"`, `"Abstracts"`, `"Extended abstracts"`, `"Applications"`, `"Workshops"`, `"Tutorials"`, `"Demonstrations"`, `"Posters"`, `"Panels"`, `"Competitions"`, `"Miscellaneous"`, `"Presentations"`, `"Commentaries"`
